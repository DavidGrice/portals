...
const jobs = [
  ...
  ['beds/grating.wav', () => bed({ freqs: [80, 160, 240, 480], filter: 520, gain: 0.18, whisper: 1480, sub: 40, seed: 45 })],
  ...
  ['oneshot/laser-on.wav', () => oneshotToneNoise({ from: 880, to: 420, seconds: 0.09, peak: 0.1, noiseHz: 2400, noisePeak: 0.06, seed: 74 })],
  ['oneshot/detector-hit.wav', () => oneshotToneNoise({ from: 660, to: 990, seconds: 0.14, peak: 0.09, noiseHz: 1800, noisePeak: 0.04, seed: 75 })],
