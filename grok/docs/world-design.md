...
Worlds stay **data**. A hall is JSON plus catalog kinds. Code loads, draws, and collides — it does not invent rooms. New places (neon grid, ages chain, anything after) follow this file.
